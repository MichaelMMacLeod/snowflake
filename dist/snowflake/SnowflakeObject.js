...
export const draw = (g, snowflake, foregroundColor, drawBranchSides) => {
    ...
    forEachGrowingBranch(snowflake, (b, _) => anyPartOutside || (anyPartOutside = Branches.draw(g, b, drawBranchSides)));
